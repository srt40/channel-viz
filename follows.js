(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'FkohoopvU7oM9YqgmElTnVJqPvL9GfP8mtQO8ZHWu3xyDOMf', // Unique master Xively API key to be used as a default
		defaultFeeds	= [158906343], // Comma separated array of Xively Feed ID numbers
							...
							xively.datastream.history(feedId, datastream.id, {duration: duration, interval: interval, limit: 1000}, function(datastreamData) {
								...
								if(datastreamData.datapoints) {
									...
									var graph = new Rickshaw.Graph( {
										...
										height: 200,
										renderer: 'line',
										min: -20, // parseFloat(datastream.min_value) - .25*(parseFloat(datastream.max_value) - parseFloat(datastream.min_value)),
										max: 20, //parseFloat(datastream.max_value) + .25*(parseFloat(datastream.max_value) - parseFloat(datastream.min_value)),
										padding: {
											top: 0.02,
											right: 0.02,
											bottom: 0.02,
